...
namespace OrganizerApp.WebUI.Helpers.View.ContentGenerator.Implementations
{
    public class TaskEditContentGenerator : ITaskContentGenerator
    {
        ...
        public string GetContextHtmlSelectedState(string context, string expectedContextValue)
        {
            return String.Equals(expectedContextValue, context, StringComparison.Ordinal) ? "selected" : "";
        }
